...
<body>
    ...
    <section id="facilities">
        <div class="container">
            <div class="title">
                <h1>Mota ZX-10R</h1>
                <p>Toda a informação sobre a mota ZX-10R!</p>
                <hr>
            </div>
            <div class="row">
                <div class="main">
                    <div class="content">
                        <img src="../assets/zx10r.jpg" alt="Ducati" style="width:100%"><br>
                        <br><br>
                        <p>Tu podes vencer todos os teus adversários, no entanto ainda falta enfrentar o verdadeiro desafio, o de desafiares-te a ti mesmo. </p>
                        <p>Para aqueles que como tu esperam estar à altura qualquer desafio, desenvolvemos a moto que os verdadeiros campeões merecem. </p>
                    </div>
                </div>
            </div>
        </div>
