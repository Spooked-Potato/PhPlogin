...
<body>
    ...
    <section id="facilities">
        <div class="container">
            <div class="title">
                <h1>Mota MT-09-Tracer</h1>
                <p>Toda a informação sobre a mota MT-09-Tracer!</p>
                <hr>
            </div>
            <div class="row">
                <div class="main">
                    <div class="content">
                        <img src="../assets/mt09tracer.jpg" alt="Africa-Twin" style="width:100%"><br>
                        <br><br>
                        <p>O mundo do Sport Touring mudou para sempre quando a Yamaha lançou o primeiro TRACER.</p>
                        <p> Sua combinação de desempenho emocionante e rico em torque com notável conforto de longa distância revolucionou totalmente a categoria.</p>
                        <p> E, desde então, mais de 50.000 pilotos escolheram o TRACER e o tornaram o modelo mais vendido da classe.</p>
                    </div>
                </div>
            </div>
        </div>
