...
<body>
    ...
    <section id="facilities">
        <div class="container">
            <div class="title">
                <h1>Mota MT-10</h1>
                <p>Toda a informação sobre a mota Mt-10!</p>
                <hr>
            </div>
            <div class="row">
                <div class="main">
                    <div class="content">
                        <img src="../assets/mt10.jpg" alt="MT-10" style="width:100%"><br>
                        <br><br>
                        <p>Indo para o trabalho, embarcando em uma viagem ou indo para as estradas vicinais, a MT-10 Tourer Edition é o seu tipo de bicicleta nua..</p>
                    </div>
                </div>
            </div>
        </div>
